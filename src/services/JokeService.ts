    ...
    try {
      const completion = await this.groq.chat.completions.create({
        ...
        messages: [
          ...
          {
            role: 'user',
            content: `Придумай одну язвительную, но добродушную шутку про то, что ${userName} слился с игры или тренировки. 1-2 предложения (лучше одно предложение), желательно с неожиданной концовкой.`,
          },
        ],
        max_tokens: 120,
        temperature: 0.9,
